...
2. **Phase 4** -- export clean-layer data for Power BI and document the
   ...
   machine with Power BI Desktop installed. Worth waiting for the
   schedule above to accumulate at least a few days/weeks of real
   forecast history first, or the dashboard will just be visualizing the
   same 6-row caveat from Phase 3.
